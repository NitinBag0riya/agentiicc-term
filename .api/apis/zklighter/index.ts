...
class SDK {
  ...
  constructor() {
    ...
    this.core = new APICore(this.spec, 'zklighter/1.0.0 (api/6.1.3)');
  }
   ...
   *
   * @summary createToken
   * @throws FetchError<400, types.CreateTokenResponse400> Bad request
   */
  createToken(body: types.CreateTokenBodyParam, metadata?: types.CreateTokenMetadataParam): Promise<FetchResponse<200, types.CreateTokenResponse200>> {
    return this.core.fetch('/api/v1/tokens/create', 'post', body, metadata);
  }
   ...
   *
   * @summary revokeToken
   * @throws FetchError<400, types.RevokeTokenResponse400> Bad request
   */
  revokeToken(body: types.RevokeTokenBodyParam, metadata?: types.RevokeTokenMetadataParam): Promise<FetchResponse<200, types.RevokeTokenResponse200>> {
    return this.core.fetch('/api/v1/tokens/revoke', 'post', body, metadata);
  }
   ...
   * Use a referral code
   *
   * @summary use_referral_code
   * @throws FetchError<400, types.UseReferralCodeResponse400> Bad request
   */
  use_referral_code(body: types.UseReferralCodeBodyParam, metadata?: types.UseReferralCodeMetadataParam): Promise<FetchResponse<200, types.UseReferralCodeResponse200>> {
    return this.core.fetch('/api/v1/referral/use', 'post', body, metadata);
  }
  ...
  /**
   * List all API tokens for the specified account.
   *
   * @summary listTokens
   * @throws FetchError<400, types.ListTokensResponse400> Bad request
   */
  listTokens(metadata: types.ListTokensMetadataParam): Promise<FetchResponse<200, types.ListTokensResponse200>> {
    return this.core.fetch('/api/v1/tokens', 'get', metadata);
  }
   ...
   * @throws FetchError<400, types.AssetDetailsResponse400> Bad request
   */
  assetDetails(metadata?: types.AssetDetailsMetadataParam): Promise<FetchResponse<200, types.AssetDetailsResponse200>> {
    return this.core.fetch('/api/v1/assetDetails', 'get', metadata);
  }
}
...
export type { AccountActiveOrdersMetadataParam, AccountActiveOrdersResponse200, AccountActiveOrdersResponse400, AccountInactiveOrdersMetadataParam, AccountInactiveOrdersResponse200, AccountInactiveOrdersResponse400, AccountLimitsMetadataParam, AccountLimitsResponse200, AccountLimitsResponse400, AccountMetadataMetadataParam, AccountMetadataParam, AccountMetadataResponse200, AccountMetadataResponse400, AccountResponse200, AccountResponse400, AccountTxsMetadataParam, AccountTxsResponse200, AccountTxsResponse400, AccountsByL1AddressMetadataParam, AccountsByL1AddressResponse200, AccountsByL1AddressResponse400, AnnouncementResponse200, AnnouncementResponse400, ApikeysMetadataParam, ApikeysResponse200, ApikeysResponse400, AssetDetailsMetadataParam, AssetDetailsResponse200, AssetDetailsResponse400, BlockMetadataParam, BlockResponse200, BlockResponse400, BlockTxsMetadataParam, BlockTxsResponse200, BlockTxsResponse400, BlocksMetadataParam, BlocksResponse200, BlocksResponse400, CandlesticksMetadataParam, CandlesticksResponse200, CandlesticksResponse400, ChangeAccountTierBodyParam, ChangeAccountTierMetadataParam, ChangeAccountTierResponse200, ChangeAccountTierResponse400, CreateTokenBodyParam, CreateTokenMetadataParam, CreateTokenResponse200, CreateTokenResponse400, CurrentHeightResponse200, CurrentHeightResponse400, DepositHistoryMetadataParam, DepositHistoryResponse200, DepositHistoryResponse400, ExchangeStatsResponse200, ExchangeStatsResponse400, ExportMetadataParam, ExportResponse200, ExportResponse400, FastbridgeInfoResponse200, FastbridgeInfoResponse400, FundingRatesResponse200, FundingRatesResponse400, FundingsMetadataParam, FundingsResponse200, FundingsResponse400, InfoResponse200, InfoResponse400, L1MetadataMetadataParam, L1MetadataResponse200, L1MetadataResponse400, LiquidationsMetadataParam, LiquidationsResponse200, LiquidationsResponse400, ListTokensMetadataParam, ListTokensResponse200, ListTokensResponse400, NextNonceMetadataParam, NextNonceResponse200, NextNonceResponse400, NotificationAckBodyParam, NotificationAckMetadataParam, NotificationAckResponse200, NotificationAckResponse400, OrderBookDetailsMetadataParam, OrderBookDetailsResponse200, OrderBookDetailsResponse400, OrderBookOrdersMetadataParam, OrderBookOrdersResponse200, OrderBookOrdersResponse400, OrderBooksMetadataParam, OrderBooksResponse200, OrderBooksResponse400, PnlMetadataParam, PnlResponse200, PnlResponse400, PositionFundingMetadataParam, PositionFundingResponse200, PositionFundingResponse400, PublicPoolsMetadataMetadataParam, PublicPoolsMetadataResponse200, PublicPoolsMetadataResponse400, RecentTradesMetadataParam, RecentTradesResponse200, RecentTradesResponse400, ReferralPointsMetadataParam, ReferralPointsResponse200, ReferralPointsResponse400, RevokeTokenBodyParam, RevokeTokenMetadataParam, RevokeTokenResponse200, RevokeTokenResponse400, SendTxBatchBodyParam, SendTxBatchResponse200, SendTxBatchResponse400, SendTxBodyParam, SendTxResponse200, SendTxResponse400, StatusResponse200, StatusResponse400, TradesMetadataParam, TradesResponse200, TradesResponse400, TransferFeeInfoMetadataParam, TransferFeeInfoResponse200, TransferFeeInfoResponse400, TransferHistoryMetadataParam, TransferHistoryResponse200, TransferHistoryResponse400, TxFromL1TxHashMetadataParam, TxFromL1TxHashResponse200, TxFromL1TxHashResponse400, TxMetadataParam, TxResponse200, TxResponse400, TxsMetadataParam, TxsResponse200, TxsResponse400, UseReferralCodeBodyParam, UseReferralCodeMetadataParam, UseReferralCodeResponse200, UseReferralCodeResponse400, WithdrawHistoryMetadataParam, WithdrawHistoryResponse200, WithdrawHistoryResponse400, WithdrawalDelayResponse200, WithdrawalDelayResponse400 } from './types';
